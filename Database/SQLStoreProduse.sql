...
CREATE PROCEDURE LayDanhSachHocSinhTheoNamHoc 
	@maNamHoc VARCHAR(6)
AS
BEGIN
...
AS
BEGIN
	INSERT INTO HOCSINH (MaHocSinh, HoTen, GioiTinh, NgaySinh, DiaChi, HoTenCha, MaNgheCha,SdtCha, HoTenMe, MaNgheMe,SdtMe, Email) 
	VALUES (@maHocSinh, @hoTen, @gioiTinh, @ngaySinh, @diaChi, @hoTenCha, @maNgheCha,@SdtCha, @hoTenMe, @maNgheMe,@SdtMe, @email)
END
GO

-------------------------------------------Lưu vào học sinh vào lớp ----------------------------------------------------
...
------------------------------Danh sach diem thi cua hoc sinh ----------------------------------------------------------------------------
